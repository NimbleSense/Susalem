...
namespace Susalem.Common.Utilities
{
    /// <summary>
    ...
    public static class StringCipherHelper
    {
        ...
        {
            //return RandomNumberGenerator.Create().GetBytes(BitConverter.GetBytes(32));
            return null;
        }

        private static byte[] Generate128BitsOfRandomEntropy()
        {
            //return RandomNumberGenerator.GetBytes(BitConverter.GetBytes(16));
            return null;
        }
